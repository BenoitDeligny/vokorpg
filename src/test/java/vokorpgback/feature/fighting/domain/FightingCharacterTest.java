...
public class FightingCharacterTest {
    ...
    void fightingCharacter_should_haveZeroCombatDice() {
        // given
        FightingCharacter fightingCharacter = new FightingCharacter(5, 5);
    ...
    void fightingCharacter_should_haveOneCombatDice() {
        // given
        FightingCharacter fightingCharacter = new FightingCharacter(15, 5);
    ...
    void fightingCharacter_should_haveTwoCombatDice() {
        // given
        FightingCharacter fightingCharacter = new FightingCharacter(25, 5);
    ...
    void fightingCharacter_should_haveThreeCombatDice() {
        // given
        FightingCharacter fightingCharacter = new FightingCharacter(45, 5);
    ...
    void fightingCharacter_should_haveFourCombatDice() {
        // given
        FightingCharacter fightingCharacter = new FightingCharacter(65, 5);
    ...
    void fightingCharacter_should_haveFiveCombatDice() {
        // given
        FightingCharacter fightingCharacter = new FightingCharacter(105, 5);
    ...
    void fightingCharacter_should_haveSixCombatDice() {
        // given
        FightingCharacter fightingCharacter = new FightingCharacter(135, 5);
    ...
    void fightingCharacter_should_haveSevenCombatDice() {
        // given
        FightingCharacter fightingCharacter = new FightingCharacter(165, 5);
    ...
    void fightingCharacter_should_haveEightCombatDice() {
        // given
        FightingCharacter fightingCharacter = new FightingCharacter(215, 5);
    ...
    void fightingCharacter_should_haveNineCombatDice() {
        // given
        FightingCharacter fightingCharacter = new FightingCharacter(255, 5);
    ...
    void fightingCharacter_should_haveTenCombatDice() {
        // given
        FightingCharacter fightingCharacter = new FightingCharacter(555, 5);
    ...
    void fightingCharacter_should_beDead() {
        // given
        FightingCharacter character = new FightingCharacter(100, 0);
    ...
    void fightingCharacter_should_beAlive() {
        // given
        FightingCharacter character = new FightingCharacter(100, 50);
